...
import com.example.demo.model.Analytcs.PaymentAnalytics;
...
public class AnalyticImpl implements AnalyticGuide{
    ...
    public boolean addOrder(Long depotId) {
        OrderAnalytics orderAnalytics = (OrderAnalytics) orderAnalyticsRepo.findByDateAndDepotId(DateUtils.day(), depotId);
